...
void UserInterface::start() {
    ...
    if (outputMode == 1) {
        abstractWatch = new CSVWatchlist(R"(D:\OOP Assignements\Assignmnents\a67-911-buiciuc-andrei\CSVWatchlist.txt)");
        this->absWatchlist = abstractWatch;
    } else {
        abstractWatch = new HTMLWatchlist(
                R"(D:\OOP Assignements\Assignmnents\a67-911-buiciuc-andrei\HTMLWatchlist.html)");
        this->absWatchlist = abstractWatch;
    }
